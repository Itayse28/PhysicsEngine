...
namespace GraphicsTest
{
    internal class Scene
    {
        ...
        public void addPhysicsObject(String name, double x, double y, double z, bool rotate, bool face, double xspeed, double yspeed, double zspeed, double weight, int gravity)
        {
            switch (name.ToLower())
            {
                case ("cube"):
                    objects.Add(new PhysicsObject(Models.cubeVertex, Models.cubeEdges, Models.cubeFaces, x, y, z, rotate, face, xspeed, yspeed, zspeed, weight));
                    break;
                case ("plane"):
                    objects.Add(new PhysicsObject(Models.planeVertex, Models.planeEdges, Models.planeFaces, x, y, z, rotate, face, xspeed, yspeed, zspeed, weight));
                    break;
                case ("pyramid"):
                    objects.Add(new PhysicsObject(Models.pyramidVertex, Models.pyramidEdges, Models.pyramidFaces, x, y, z, rotate, face, xspeed, yspeed, zspeed, weight));
                    break;
                case ("gear"):
                    objects.Add(new PhysicsObject(Models.gearVertex, Models.gearEdges, Models.gearFaces, 0, 0, 0, rotate, face, xspeed, yspeed, zspeed, weight));
                    ...
                    break;
                case ("sphere"):
                    objects.Add(new PhysicsObject(Models.sphereVertex, Models.sphereEdges, Models.sphereFaces, 0, 0, 0, rotate, face, xspeed, yspeed, zspeed, weight));
                    ...
                    break;
                case ("torus"):
                    objects.Add(new PhysicsObject(Models.torusVertex, Models.torusEdges, Models.torusFaces, 0, 0, 0, rotate, face, xspeed, yspeed, zspeed, weight));
                    objects[objects.Count - 1].rotate('x', 90);
                    ...
                    break;
                case ("candle"):
                    objects.Add(new PhysicsObject(Models.candleVertex, Models.candleEdges, Models.candleFaces, 0, 0, 0, rotate, face, xspeed, yspeed, zspeed, weight));
                    ...
                    break;
                case ("pistol"):
                    objects.Add(new PhysicsObject(Models.pistolVertex, Models.pistolEdges, Models.pistolFaces, 0, 0, 0, rotate, face, xspeed, yspeed, zspeed, weight));
                    objects[objects.Count - 1].rotate('x', 180);
                    objects[objects.Count - 1].rescale(60);
                    objects[objects.Count - 1].move('x', x);
                    objects[objects.Count - 1].move('y', y);
                    ...
                    break;
                case ("hand"):
                    objects.Add(new PhysicsObject(Models.handVertex, Models.handEdges, Models.handFaces, 0, 0, 0, rotate, face, xspeed, yspeed, zspeed, weight));
                    objects[objects.Count - 1].rotate('x', 90);
                    objects[objects.Count - 1].rescale(60);
                    objects[objects.Count - 1].move('x', x);
                    objects[objects.Count - 1].move('y', y);
                    ...
                    break;
                case ("damca"):
                    objects.Add(new PhysicsObject(Models.damcaVertex, Models.damcaEdges, Models.damcaFaces, 0, 0, 0, rotate, face, xspeed, yspeed, zspeed, weight));
                    objects[objects.Count - 1].rotate('x', 90);
                    objects[objects.Count - 1].rescale(80);
                    objects[objects.Count - 1].move('x', x);
                    objects[objects.Count - 1].move('y', y);
                    ...
                    break;
                case ("itay"):
                    objects.Add(new PhysicsObject(Models.ITAYVertex, Models.ITAYEdges, Models.ITAYFaces, 0, 0, 0, rotate, face, xspeed, yspeed, zspeed, weight));
                    objects[objects.Count - 1].rotate('x', 90);
                    objects[objects.Count - 1].rescale(80);
                    objects[objects.Count - 1].move('x', x);
                    objects[objects.Count - 1].move('y', y);
            ...
            ((PhysicsObject)objects[objects.Count - 1]).yforce = 0.2 * gravity;
        }
        public void addPhysicsObject(String name, double x, double y, double z, bool rotate, bool face, double xspeed, double yspeed, double zspeed)
        {
            //adds a passive physics object
            addPhysicsObject(name, x, y, z, rotate, face, xspeed, yspeed, zspeed, 2000000, 0);
        }
        ...
        public async void update()
        {
            ...
            for (int i=0;i<objects.Count;i++)
            {
                if (objects[i] is PhysicsObject)
                {
                    ...
                    obj.xspeed += obj.xforce;
                    obj.yspeed += obj.yforce;
                    obj.zspeed += obj.zforce;
                    ...
                    for (int j = 0; j < objects.Count; j++)
                    {
                        if (i != j && objects[j] is PhysicsObject)
                        {
                            ...
                            if (Math.Sqrt((obj2.x - obj.x) * (obj2.x - obj.x) + (obj2.y - obj.y) * (obj2.y - obj.y) + (obj2.z - obj.z) * (obj2.z - obj.z)) < 150 &&
                                (!obj.collided.Contains(obj2) || !obj2.collided.Contains(obj)))
                            {
                                obj.move('x', -v1x);
                                obj.move('y', -v1y);
                                obj.move('z', -v1z);
